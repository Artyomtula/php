...
*/
define('SITE_NAME', 'Мой сайт на PHP');
const MAX_USERS = 100;
?>
<!DOCTYPE html>
<html lang="ru">
...
<body>
    ...
    */
    ...
    if (defined('SITE_NAME')) {
        echo "Константа SITE_NAME существует. Значение: " . SITE_NAME . "<br>";
    }
    
    if (defined('MAX_USERS')) {
        echo "Константа MAX_USERS существует. Значение: " . MAX_USERS . "<br>";
    }
    ...
    */
    ...
    echo "<br>Текущая версия PHP: " . PHP_VERSION . "<br>";
